...
exports.run = (client, message, params) => {
  if (!params[0]) {
	...
	message.channel.send({embed: {
            ...
            title: "",
            description: "[Davet Linkim](https://discord.com/oauth2/authorize?client_id=828570926257405962&scope=bot&permissions=8) \n[Destek Sunucusu](https://discord.gg/hWhFFWaqb3)",
            fields: [
            ],
            timestamp: new Date(),
            footer: {
